...
> **状态: ⚠ 暂定稿 (DRAFT)** — 费率数据已按 Seller Central 官方页面全部核对补齐（2026-08-19 重读 12 页），缺口清零；待复核后定稿。
> 最后更新: 2026-08-19 | 数据版本: 2.2 (官方费率全表核对 + 2026尺寸分段/发货重量修正)
...
- [ ] **人工复核** — 官方页费率已全部录入，建议抽查 3-5 档与 Seller Central 页面比对后定稿
