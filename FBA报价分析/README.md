...
> **状态: ✅ 定稿 (FINAL)** — 费率数据已按 Seller Central 官方页面全部核对补齐（2026-08-19 重读 12 页，缺口清零），2026-08-20 定稿。
> 最后更新: 2026-08-20 | 数据版本: 2.2 (官方费率全表核对 + 2026尺寸分段/发货重量修正)
...
- 输出: FBA配送费 + 仓储费 + AGL头程分摊 + 燃油附加费 + 合计；显示商品重/体积重/发货重量
...
2. **AGL 计算器**: 使用全量 LCL 路由均价，实际需根据具体起运港/目的 FC 精确匹配
...
## 三产品验证 (2026-08-19 重算, 含体积重)

| 产品 | 尺寸(cm) | 商品重 | 发货重量* | 分段 | 配送费 | 仓储(3月) | AGL | 合计 |
|---|---|---|---|---|---|---|---|---|
| P1 | 80×48×37 | 23kg | 62.4lb (体积重) | 超大件 50-70 | $45.87 | $8.43 | $212.17 | $268.07 |
| P2 | 68×48×35 | 20kg | 50.2lb (体积重) | **超大件 50-70** | $37.32 | $6.78 | $212.17 | $257.58 |
| P3 | 76×53.5×50 | 32.2kg | 89.3lb (体积重) | 超大件 70-150 | $65.05 | $12.06 | $212.17 | $291.56 |

> *发货重量 = max(商品重, 体积重 L×W×H÷139)。条件: FOB / 燃油附加费(3.5%) / 非旺季 / 非服装 / $10-50 售价档位 / 仓储 3 个月。
>
